...
\OCP\Util::addScript(\OCA\Voxonta\AppInfo\Application::APP_ID,
	\OCA\Voxonta\AppInfo\Application::APP_ID . '-main');
...
<div class="section">
	...
	<p class="voxonta-status">
		<span class="voxonta-status__dot voxonta-status__dot--<?php p($state); ?>"></span>
		<?php p($headline); ?>
	</p>

	<?php if ($detail !== '') { ?>
		<p class="voxonta-status__detail"><?php p($detail); ?></p>
	<?php } ?>

	<div id="voxonta_bot" class="voxonta-bot">
		<h3><?php p($l->t('Capture account')); ?></h3>
		<p class="voxonta-status__detail">
		...
		<details class="voxonta-bot__manual">
		...
		<div data-role="result" class="voxonta-bot__result"></div>
	</div>
</div>
...
<style>
	...
	.voxonta-status__dot--ok { background: var(--color-success); }
	.voxonta-status__dot--warn { background: var(--color-warning); }
	.voxonta-status__dot--idle { background: var(--color-text-maxcontrast); }

	.voxonta-status__detail {
